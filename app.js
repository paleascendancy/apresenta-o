...
document.querySelectorAll('[data-answer]').forEach(b=>b.onclick=()=>{document.querySelectorAll('[data-answer]').forEach(x=>x.classList.remove('selected'));b.classList.add('selected');document.getElementById('feedback').textContent=b.dataset.answer==='b'?'Correto! B usa urgência: “Última chance” tenta acelerar a compra. A informa a capacidade da garrafa: 500 ml.':'A informa uma característica: a garrafa comporta 500 ml. A resposta é B, pois “Última chance” tenta fazer a pessoa comprar logo.'});
